...
{
  /* sensor */
  CUSTOM_STM_TEMPERATURE_PRESSURE,
} Custom_STM_Char_Opcode_t;

typedef enum
{
  /* Temperature_Pressure */
  CUSTOM_STM_TEMPERATURE_PRESSURE_READ_EVT,
  CUSTOM_STM_TEMPERATURE_PRESSURE_NOTIFY_ENABLED_EVT,
  CUSTOM_STM_TEMPERATURE_PRESSURE_NOTIFY_DISABLED_EVT,
...
/* Exported constants --------------------------------------------------------*/
extern uint16_t SizeTemperature_Pressure;
